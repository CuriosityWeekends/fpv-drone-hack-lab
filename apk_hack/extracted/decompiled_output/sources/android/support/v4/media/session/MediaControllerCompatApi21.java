...
public class MediaControllerCompatApi21 {
    ...
    public interface Callback {
        void onAudioInfoChanged(int i3, int i5, int i6, int i7, int i8);
    ...
    public static void adjustVolume(Object obj, int i3, int i5) {
        ((MediaController) obj).adjustVolume(i3, i5);
    }
    ...
    public static void setVolumeTo(Object obj, int i3, int i5) {
        ((MediaController) obj).setVolumeTo(i3, i5);
    }
