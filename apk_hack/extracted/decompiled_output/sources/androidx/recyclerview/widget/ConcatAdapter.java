...
public final class ConcatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int findRelativeAdapterPositionIn(@NonNull RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter, @NonNull RecyclerView.ViewHolder viewHolder, int i3) {
        return this.mController.getLocalAdapterPosition(adapter, viewHolder, i3);
    }
