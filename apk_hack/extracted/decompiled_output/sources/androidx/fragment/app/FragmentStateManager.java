...
public class FragmentStateManager {
    ...
    public void attach() {
        ...
        if (fragment2 != null) {
            ...
            if (str != null && (fragmentStateManager = this.mFragmentStore.getFragmentStateManager(str)) == null) {
                ...
                throw new IllegalStateException(i.k(sb, this.mFragment.mTargetWho, " that does not belong to this FragmentManager!"));
            }
        }
    ...
    public int computeExpectedState() {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            StringBuilder m5 = i.m("computeExpectedState() of ", i3, " for ");
            m5.append(this.mFragment);
