...
public class ListFragment extends Fragment {
    ...
    private final AdapterView.OnItemClickListener mOnClickListener = new AdapterView.OnItemClickListener() { // from class: androidx.fragment.app.ListFragment.2
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i3, long j2) {
            ListFragment.this.onListItemClick((ListView) adapterView, view, i3, j2);
        }
    };
    ...
    public void onListItemClick(@NonNull ListView listView, @NonNull View view, int i3, long j2) {
    }
    ...
    private void setListShown(boolean z3, boolean z5) {
        ensureList();
