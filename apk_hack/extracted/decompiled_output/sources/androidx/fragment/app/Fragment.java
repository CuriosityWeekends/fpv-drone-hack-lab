...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(@NonNull final ActivityResultContract<I, O> activityResultContract, @NonNull final Function<Void, ActivityResultRegistry> function, @NonNull final ActivityResultCallback<O> activityResultCallback) {
        ...
        throw new IllegalStateException(i.g("Fragment ", this, " is attempting to registerForActivityResult after being created. Fragments must call registerForActivityResult() before they are created (i.e. initialization, onAttach(), or onCreate())."));
    }
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        this.mChildFragmentManager.dump(i.h(str, "  "), fileDescriptor, printWriter, strArr);
    }
    ...
    public final FragmentManager getChildFragmentManager() {
        ...
        throw new IllegalStateException(i.g("Fragment ", this, " has not been attached yet."));
    }
    ...
    public final FragmentManager getParentFragmentManager() {
        ...
        throw new IllegalStateException(i.g("Fragment ", this, " not associated with a fragment manager."));
    }
    ...
    @Nullable
    @MainThread
    public Animation onCreateAnimation(int i3, boolean z3, int i5) {
        return null;
    }

    @Nullable
    @MainThread
    public Animator onCreateAnimator(int i3, boolean z3, int i5) {
        return null;
    }
    ...
    public void performActivityCreated(Bundle bundle) {
        ...
        throw new SuperNotCalledException(i.g("Fragment ", this, " did not call through to super.onActivityCreated()"));
    }
    ...
    public void performAttach() {
        ...
        throw new SuperNotCalledException(i.g("Fragment ", this, " did not call through to super.onAttach()"));
    }
    ...
    public void performCreate(Bundle bundle) {
        ...
        throw new SuperNotCalledException(i.g("Fragment ", this, " did not call through to super.onCreate()"));
    }
    ...
    public void performDestroy() {
        ...
        throw new SuperNotCalledException(i.g("Fragment ", this, " did not call through to super.onDestroy()"));
    }
    ...
    public void performDestroyView() {
        ...
        throw new SuperNotCalledException(i.g("Fragment ", this, " did not call through to super.onDestroyView()"));
    }
    ...
    public void performDetach() {
        ...
        throw new SuperNotCalledException(i.g("Fragment ", this, " did not call through to super.onDetach()"));
    }
    ...
    public void performPause() {
        ...
        throw new SuperNotCalledException(i.g("Fragment ", this, " did not call through to super.onPause()"));
    }
    ...
    public void performResume() {
        ...
        throw new SuperNotCalledException(i.g("Fragment ", this, " did not call through to super.onResume()"));
    }
    ...
    public void performStart() {
        ...
        throw new SuperNotCalledException(i.g("Fragment ", this, " did not call through to super.onStart()"));
    }
    ...
    public void performStop() {
        ...
        throw new SuperNotCalledException(i.g("Fragment ", this, " did not call through to super.onStop()"));
    }
    ...
    public final void requestPermissions(@NonNull String[] strArr, int i3) {
        ...
        throw new IllegalStateException(i.g("Fragment ", this, " not attached to Activity"));
    }
    ...
    public final FragmentActivity requireActivity() {
        ...
        throw new IllegalStateException(i.g("Fragment ", this, " not attached to an activity."));
    }
    ...
    public final Bundle requireArguments() {
        ...
        throw new IllegalStateException(i.g("Fragment ", this, " does not have any arguments."));
    }
    ...
    public final Context requireContext() {
        ...
        throw new IllegalStateException(i.g("Fragment ", this, " not attached to a context."));
    }
    ...
    public final Object requireHost() {
        ...
        throw new IllegalStateException(i.g("Fragment ", this, " not attached to a host."));
    }
    ...
    public final Fragment requireParentFragment() {
        ...
        if (parentFragment == null) {
            if (getContext() == null) {
                throw new IllegalStateException(i.g("Fragment ", this, " is not attached to any Fragment or host"));
            }
    ...
    public final View requireView() {
        ...
        throw new IllegalStateException(i.g("Fragment ", this, " did not return a View from onCreateView() or this was called before onCreateView()."));
    }
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        throw new SuperNotCalledException(i.g("Fragment ", this, " did not call through to super.onViewStateRestored()"));
    }
    ...
    public void setAnimations(int i3, int i5, int i6, int i7) {
        if (this.mAnimationInfo == null && i3 == 0 && i5 == 0 && i6 == 0 && i7 == 0) {
            return;
        }
    ...
    public void setTargetFragment(@Nullable Fragment fragment, int i3) {
        ...
        if (fragmentManager2 != null && fragmentManager != null && fragmentManager2 != fragmentManager) {
            throw new IllegalArgumentException(i.g("Fragment ", fragment, " must share the same FragmentManager to be set as a target fragment"));
        }
    ...
    public void startIntentSenderForResult(@SuppressLint({"UnknownNullness"}) IntentSender intentSender, int i3, @Nullable Intent intent, int i5, int i6, int i7, @Nullable Bundle bundle) {
        if (this.mHost != null) {
            ...
            getParentFragmentManager().launchStartIntentSenderForResult(this, intentSender, i3, intent, i5, i6, i7, bundle);
            return;
        }
        throw new IllegalStateException(i.g("Fragment ", this, " not attached to Activity"));
    }
    ...
    public static Fragment instantiate(@NonNull Context context, @NonNull String str, @Nullable Bundle bundle) {
        try {
            ...
            throw new InstantiationException(i.i("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e5);
        } catch (java.lang.InstantiationException e6) {
            throw new InstantiationException(i.i("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e6);
        } catch (NoSuchMethodException e7) {
            throw new InstantiationException(i.i("Unable to instantiate fragment ", str, ": could not find Fragment constructor"), e7);
        } catch (InvocationTargetException e8) {
            throw new InstantiationException(i.i("Unable to instantiate fragment ", str, ": calling Fragment constructor caused an exception"), e8);
        }
    }
