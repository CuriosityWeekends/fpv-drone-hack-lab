...
public final class MenuItemCompat {
    ...
    public static void setAlphabeticShortcut(MenuItem menuItem, char c, int i3) {
        if (menuItem instanceof SupportMenuItem) {
    ...
    public static void setNumericShortcut(MenuItem menuItem, char c, int i3) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setNumericShortcut(c, i3);
        } else if (Build.VERSION.SDK_INT >= 26) {
    ...
    public static void setShortcut(MenuItem menuItem, char c, char c5, int i3, int i5) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setShortcut(c, c5, i3, i5);
        } else if (Build.VERSION.SDK_INT >= 26) {
            menuItem.setShortcut(c, c5, i3, i5);
        }
    }
