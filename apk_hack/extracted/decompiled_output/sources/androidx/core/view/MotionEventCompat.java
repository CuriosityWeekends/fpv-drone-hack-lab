...
public final class MotionEventCompat {
    ...
    public static float getAxisValue(MotionEvent motionEvent, int i3) {
        return motionEvent.getAxisValue(i3);
    }
    ...
    public static boolean isFromSource(MotionEvent motionEvent, int i3) {
        if ((motionEvent.getSource() & i3) == i3) {
            return true;
        }
        return false;
    }
    ...
    @Deprecated
    public static float getAxisValue(MotionEvent motionEvent, int i3, int i5) {
        return motionEvent.getAxisValue(i3, i5);
    }
}
