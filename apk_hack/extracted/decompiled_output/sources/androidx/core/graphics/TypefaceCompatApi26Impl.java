...
public class TypefaceCompatApi26Impl extends TypefaceCompatApi21Impl {
    ...
    public TypefaceCompatApi26Impl() {
        ...
        try {
            ...
            Log.e(TAG, "Unable to collect necessary methods for class ".concat(e5.getClass().getName()), e5);
            cls = null;
            constructor = null;
            method = null;
            method2 = null;
    ...
    private boolean addFontFromAssetManager(Context context, Object obj, String str, int i3, int i5, int i6, @Nullable FontVariationAxis[] fontVariationAxisArr) {
        try {
            return ((Boolean) this.mAddFontFromAssetManager.invoke(obj, context.getAssets(), str, 0, Boolean.FALSE, Integer.valueOf(i3), Integer.valueOf(i5), Integer.valueOf(i6), fontVariationAxisArr)).booleanValue();
        } catch (IllegalAccessException | InvocationTargetException unused) {
            return false;
        }
    }

    private boolean addFontFromBuffer(Object obj, ByteBuffer byteBuffer, int i3, int i5, int i6) {
        try {
            return ((Boolean) this.mAddFontFromBuffer.invoke(obj, byteBuffer, Integer.valueOf(i3), null, Integer.valueOf(i5), Integer.valueOf(i6))).booleanValue();
        } catch (IllegalAccessException | InvocationTargetException unused) {
            return false;
        }
    }
    ...
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, Resources resources, int i3) {
        ...
        if (!isFontFamilyPrivateAPIAvailable()) {
            return super.createFromFontFamilyFilesResourceEntry(context, fontFamilyFilesResourceEntry, resources, i3);
        }
    ...
    public Typeface createFromResourcesFontFile(Context context, Resources resources, int i3, String str, int i5) {
        if (!isFontFamilyPrivateAPIAvailable()) {
            return super.createFromResourcesFontFile(context, resources, i3, str, i5);
        }
        Object newFamily = newFamily();
        if (newFamily == null) {
            return null;
