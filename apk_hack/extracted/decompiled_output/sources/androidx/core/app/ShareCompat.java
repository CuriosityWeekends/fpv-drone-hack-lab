...
public final class ShareCompat {
    ...
    public static class IntentBuilder {
        ...
        @NonNull
        public IntentBuilder setChooserTitle(@StringRes int i3) {
            return setChooserTitle(this.mContext.getText(i3));
        }
    ...
    public static class IntentReader {
        ...
        private static void withinStyle(StringBuilder sb, CharSequence charSequence, int i3, int i5) {
            while (i3 < i5) {
        ...
        public Uri getStream(int i3) {
            ...
            throw new IndexOutOfBoundsException("Stream items available: " + getStreamCount() + " index requested: " + i3);
        }
    }
    ...
    @Deprecated
    public static void configureMenuItem(@NonNull Menu menu, @IdRes int i3, @NonNull IntentBuilder intentBuilder) {
