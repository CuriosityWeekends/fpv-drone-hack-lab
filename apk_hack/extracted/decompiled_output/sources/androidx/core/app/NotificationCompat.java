...
public class NotificationCompat {
    ...
    public static class Action {
            ...
            */
            public static androidx.core.app.NotificationCompat.Action.Builder fromAndroidAction(@androidx.annotation.NonNull android.app.Notification.Action r5) {
                /*
                    ...
                    r1 = 23
                    if (r0 < r1) goto L1e
                    android.graphics.drawable.Icon r0 = androidx.core.app.a.i(r5)
                    if (r0 == 0) goto L1e
                    android.graphics.drawable.Icon r0 = androidx.core.app.a.i(r5)
                ...
                L42:
                    ...
                    r2 = 24
                    if (r0 < r2) goto L4e
                    boolean r2 = android.support.v4.media.b.y(r5)
                    r1.mAllowGeneratedReplies = r2
                L4e:
                    r2 = 28
                    if (r0 < r2) goto L59
                    int r2 = android.support.v4.media.session.a.a(r5)
                    r1.setSemanticAction(r2)
                L59:
                    r2 = 29
                    if (r0 < r2) goto L64
                    boolean r5 = a1.e.r(r5)
                    r1.setContextual(r5)
                L64:
                    return r1
                */
            ...
            private Builder(@Nullable IconCompat iconCompat, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @NonNull Bundle bundle, @Nullable RemoteInput[] remoteInputArr, boolean z3, int i3, boolean z5, boolean z6) {
        ...
        public static final class WearableExtender implements Extender {
            ...
            private void setFlag(int i3, boolean z3) {
                if (z3) {
        ...
        public Action(int i3, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @Nullable Bundle bundle, @Nullable RemoteInput[] remoteInputArr, @Nullable RemoteInput[] remoteInputArr2, boolean z3, int i5, boolean z5, boolean z6) {
            this(i3 != 0 ? IconCompat.createWithResource(null, "", i3) : null, charSequence, pendingIntent, bundle, remoteInputArr, remoteInputArr2, z3, i5, z5, z6);
        }

        public Action(@Nullable IconCompat iconCompat, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @Nullable Bundle bundle, @Nullable RemoteInput[] remoteInputArr, @Nullable RemoteInput[] remoteInputArr2, boolean z3, int i3, boolean z5, boolean z6) {
            this.mShowsUserInterface = true;
            this.mIcon = iconCompat;
    ...
    public static class BigPictureStyle extends Style {
        ...
        private static IconCompat asIconCompat(@Nullable Parcelable parcelable) {
            if (parcelable != null) {
                if (Build.VERSION.SDK_INT >= 23 && a.B(parcelable)) {
                    return IconCompat.createFromIcon(a.l(parcelable));
                }
    ...
    public static final class BubbleMetadata {
        ...
        public static final class Builder {
            ...
            @NonNull
            private Builder setFlag(int i3, boolean z3) {
                if (z3) {
                    this.mFlags = i3 | this.mFlags;
                } else {
                    this.mFlags = (~i3) & this.mFlags;
        ...
        private BubbleMetadata(@Nullable PendingIntent pendingIntent, @Nullable PendingIntent pendingIntent2, @Nullable IconCompat iconCompat, int i3, @DimenRes int i5, int i6, @Nullable String str) {
            this.mPendingIntent = pendingIntent;
            this.mIcon = iconCompat;
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context, @NonNull Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    addPerson(Person.fromAndroidPerson(android.support.v4.media.session.a.k(it.next())));
                }
            }
            int i3 = Build.VERSION.SDK_INT;
        ...
        @NonNull
        public Builder setLights(@ColorInt int i3, int i5, int i6) {
            int i7;
            Notification notification = this.mNotification;
        ...
        @NonNull
        public Builder setProgress(int i3, int i5, boolean z3) {
        ...
        @NonNull
        public Builder setSmallIcon(int i3, int i5) {
            Notification notification = this.mNotification;
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z3) {
            ...
            if (z3 && nonContextualActions != null && (min = Math.min(nonContextualActions.size(), 3)) > 0) {
                for (int i5 = 0; i5 < min; i5++) {
                    applyStandardTemplate.addView(R.id.actions, generateActionButton(nonContextualActions.get(i5)));
                }
            } else {
                i3 = 8;
            }
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (z3) {
                ...
                i3 = R.layout.notification_action;
            }
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            if (Build.VERSION.SDK_INT >= 24) {
                notificationBuilderWithBuilderAccessor.getBuilder().setStyle(android.support.v4.media.b.d());
            }
        }
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(@Nullable String str) {
            ...
            if (i3 >= 24) {
                if (str.equals(d.i().getName())) {
                    return new MessagingStyle();
                }
                if (str.equals(d.x().getName())) {
                    return new DecoratedCustomViewStyle();
                }
            }
            return null;
        ...
        private Bitmap createIconWithBackground(int i3, int i5, int i6, int i7) {
        ...
        */
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public Bitmap createColoredBitmap(int i3, int i5) {
            return createColoredBitmap(i3, i5, 0);
        }
        ...
        public Bitmap createColoredBitmap(@NonNull IconCompat iconCompat, int i3) {
            return createColoredBitmap(iconCompat, i3, 0);
        }

        private Bitmap createColoredBitmap(int i3, int i5, int i6) {
            return createColoredBitmap(IconCompat.createWithResource(this.mBuilder.mContext, i3), i5, i6);
        }

        private Bitmap createColoredBitmap(@NonNull IconCompat iconCompat, int i3, int i5) {
    ...
    public static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i7 = 0; i7 < remoteInputs.length; i7++) {
                ...
                remoteInputArr2[i7] = new RemoteInput(resultKey, label, choices, allowFreeFormInput, i3, remoteInput.getExtras(), null);
            }
        ...
        if (i8 >= 23) {
            ...
            if (icon != null || (i6 = action.icon) == 0) {
                ...
                return new Action(iconCompat, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z6, i9, z7, z5);
            }
            return new Action(i6, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z6, i9, z7, z5);
        }
        return new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z6, i9, z7, z5);
    }
    ...
    */
    public static androidx.core.content.LocusIdCompat getLocusId(@androidx.annotation.NonNull android.app.Notification r3) {
        /*
            ...
            r2 = 0
            if (r0 < r1) goto L12
            android.content.LocusId r3 = a1.e.d(r3)
            if (r3 != 0) goto Le
            goto L12
        Le:
    ...
    public static List<Person> getPeople(@NonNull Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                Iterator it = parcelableArrayList.iterator();
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(android.support.v4.media.session.a.k(it.next())));
                }
            }
        } else {
    ...
    public static final class CarExtender implements Extender {
        ...
        private static Bundle getBundleForUnreadConversation(@NonNull UnreadConversation unreadConversation) {
            ...
            for (int i3 = 0; i3 < length; i3++) {
                ...
                bundle2.putString(KEY_TEXT, unreadConversation.getMessages()[i3]);
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            CharSequence text;
            CharSequence text2;
            Notification.MessagingStyle f4;
            setGroupConversation(isGroupConversation());
            int i3 = Build.VERSION.SDK_INT;
            if (i3 >= 24) {
                if (i3 >= 28) {
                    android.support.v4.media.b.k();
                    f4 = android.support.v4.media.session.a.c(this.mUser.toAndroidPerson());
                } else {
                    android.support.v4.media.b.k();
                    f4 = android.support.v4.media.b.f(this.mUser.getName());
                }
                for (Message message : this.mMessages) {
                    f4.addMessage(message.toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    for (Message message2 : this.mHistoricMessages) {
                        f4.addHistoricMessage(message2.toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    f4.setConversationTitle(this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    f4.setGroupConversation(this.mIsGroupConversation.booleanValue());
                }
                f4.setBuilder(notificationBuilderWithBuilderAccessor.getBuilder());
                return;
            }
        ...
        public static final class Message {
                ...
                try {
                    if (bundle.containsKey(KEY_TEXT) && bundle.containsKey(KEY_TIMESTAMP)) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            ...
                            person = Person.fromAndroidPerson(android.support.v4.media.session.a.j(bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
            ...
            public Notification.MessagingStyle.Message toAndroidMessage() {
                Notification.MessagingStyle.Message e5;
                ...
                if (Build.VERSION.SDK_INT >= 28) {
                    ...
                    e5 = android.support.v4.media.session.a.b(text, timestamp, person2);
                } else {
                    android.support.v4.media.b.B();
                    ...
                    e5 = android.support.v4.media.b.e(text2, timestamp2, charSequence);
                }
                if (getDataMimeType() != null) {
                    e5.setData(getDataMimeType(), getDataUri());
                }
                return e5;
            }
