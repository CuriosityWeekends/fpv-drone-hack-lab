...
public final class ComplexColorCompat {
    ...
    private ComplexColorCompat(Shader shader, ColorStateList colorStateList, @ColorInt int i3) {
        this.mShader = shader;
    ...
    @NonNull
    private static ComplexColorCompat createFromXml(@NonNull Resources resources, @ColorRes int i3, @Nullable Resources.Theme theme) {
        int next;
