...
public class AnimatedStateListDrawableCompat extends StateListDrawable implements TintAwareDrawable {
    ...
    public static class AnimatedStateListState extends StateListDrawable.StateListState {
        ...
        private static long generateTransitionKey(int i3, int i5) {
            return i5 | (i3 << 32);
        }

        public int addStateSet(@NonNull int[] iArr, @NonNull Drawable drawable, int i3) {
            int addStateSet = super.addStateSet(iArr, drawable);
            this.mStateIds.put(addStateSet, Integer.valueOf(i3));
            return addStateSet;
        }

        public int addTransition(int i3, int i5, @NonNull Drawable drawable, boolean z3) {
            long j2;
            int addChild = addChild(drawable);
            long generateTransitionKey = generateTransitionKey(i3, i5);
            if (z3) {
                j2 = 8589934592L;
            } else {
                j2 = 0;
            ...
            long j5 = addChild;
            this.mTransitions.append(generateTransitionKey, Long.valueOf(j5 | j2));
            if (z3) {
                this.mTransitions.append(generateTransitionKey(i5, i3), Long.valueOf(4294967296L | j5 | j2));
            }
            return addChild;
        }
        ...
        public int indexOfTransition(int i3, int i5) {
            return (int) this.mTransitions.get(generateTransitionKey(i3, i5), -1L).longValue();
        }

        public boolean isTransitionReversed(int i3, int i5) {
            if ((this.mTransitions.get(generateTransitionKey(i3, i5), -1L).longValue() & 4294967296L) != 0) {
                return true;
            }
            return false;
        }
        ...
        public boolean transitionHasReversibleFlag(int i3, int i5) {
            if ((this.mTransitions.get(generateTransitionKey(i3, i5), -1L).longValue() & 8589934592L) != 0) {
                return true;
            }
            return false;
        }
    ...
    public static class AnimationDrawableTransition extends Transition {
        ...
        public AnimationDrawableTransition(AnimationDrawable animationDrawable, boolean z3, boolean z5) {
            super();
            int i3;
    ...
    public static class FrameInterpolator implements TimeInterpolator {
        ...
        public float getInterpolation(float f4) {
            float f5;
            int i3 = (int) ((f4 * this.mTotalDuration) + 0.5f);
            int i5 = this.mFrames;
    ...
    public <T extends Drawable & Animatable> void addTransition(int i3, int i5, @NonNull T t4, boolean z3) {
        if (t4 != null) {
            this.mState.addTransition(i3, i5, t4, z3);
            return;
        }
