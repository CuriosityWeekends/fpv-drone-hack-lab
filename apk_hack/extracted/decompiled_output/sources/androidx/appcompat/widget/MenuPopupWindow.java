...
public class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
    ...
    public static class MenuDropDownListView extends DropDownListView {
        ...
        public /* bridge */ /* synthetic */ int lookForSelectablePosition(int i3, boolean z3) {
            return super.lookForSelectablePosition(i3, z3);
        }

        @Override // androidx.appcompat.widget.DropDownListView
        public /* bridge */ /* synthetic */ int measureHeightOfChildrenCompat(int i3, int i5, int i6, int i7, int i8) {
            return super.measureHeightOfChildrenCompat(i3, i5, i6, i7, i8);
        }
        ...
        public boolean onHoverEvent(MotionEvent motionEvent) {
            ...
            if (this.mHoverListener != null) {
                ...
                if (motionEvent.getAction() != 10 && (pointToPosition = pointToPosition((int) motionEvent.getX(), (int) motionEvent.getY())) != -1 && (i5 = pointToPosition - i3) >= 0 && i5 < menuAdapter.getCount()) {
        ...
        public boolean onKeyDown(int i3, KeyEvent keyEvent) {
            ...
            if (listMenuItemView != null && i3 == this.mAdvanceKey) {
                if (listMenuItemView.isEnabled() && listMenuItemView.getItemData().hasSubMenu()) {
                    performItemClick(listMenuItemView, getSelectedItemPosition(), getSelectedItemId());
                }
                return true;
            } else if (listMenuItemView != null && i3 == this.mRetreatKey) {
                setSelection(-1);
                ListAdapter adapter = getAdapter();
                if (adapter instanceof HeaderViewListAdapter) {
    ...
    public MenuPopupWindow(@NonNull Context context, @Nullable AttributeSet attributeSet, int i3, int i5) {
