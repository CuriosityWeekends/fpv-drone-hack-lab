...
public class ThemeUtils {
    ...
    @NonNull
    public static ColorStateList createDisabledStateList(int i3, int i5) {
        return new ColorStateList(new int[][]{DISABLED_STATE_SET, EMPTY_STATE_SET}, new int[]{i5, i3});
    }
    ...
    public static int getThemeAttrColor(@NonNull Context context, int i3, float f4) {
        int themeAttrColor = getThemeAttrColor(context, i3);
