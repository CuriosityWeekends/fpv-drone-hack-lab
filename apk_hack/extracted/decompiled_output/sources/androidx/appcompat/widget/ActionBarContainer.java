...
public class ActionBarContainer extends FrameLayout {
    ...
    public void onLayout(boolean z3, int i3, int i5, int i6, int i7) {
        ...
        if (view != null && view.getVisibility() != 8) {
            ...
            view.layout(i3, (measuredHeight - view.getMeasuredHeight()) - i8, i6, measuredHeight - i8);
        }
        if (this.mIsSplit) {
    ...
    public void onMeasure(int i3, int i5) {
        ...
        int i7;
        int i8;
        if (this.mActionBarView == null && View.MeasureSpec.getMode(i5) == Integer.MIN_VALUE && (i8 = this.mHeight) >= 0) {
        ...
        if (view != null && view.getVisibility() != 8 && mode != 1073741824) {
            if (!isCollapsed(this.mActionBarView)) {
                i6 = getMeasuredHeightWithMargins(this.mActionBarView);
            } else if (!isCollapsed(this.mContextView)) {
                i6 = getMeasuredHeightWithMargins(this.mContextView);
            } else {
                i6 = 0;
            }
            ...
            setMeasuredDimension(getMeasuredWidth(), Math.min(i6 + getMeasuredHeightWithMargins(this.mTabContainer), i7));
        }
    }
