...
public class ActivityChooserModel extends DataSetObservable {
    ...
    public static final class HistoricalRecord {
        ...
        public HistoricalRecord(String str, long j2, float f4) {
            this(ComponentName.unflattenFromString(str), j2, f4);
        }
        ...
        public HistoricalRecord(ComponentName componentName, long j2, float f4) {
        ...
        try {
            try {
                ...
                try {
                    ...
                    String str = LOG_TAG;
                    Log.e(str, "Error reading historical recrod file: " + this.mHistoryFileName, e5);
                    if (openFileInput == null) {
                        return;
                    }
                } catch (XmlPullParserException e6) {
                    String str2 = LOG_TAG;
                    Log.e(str2, "Error reading historical recrod file: " + this.mHistoryFileName, e6);
                    if (openFileInput == null) {
                        return;
                    }
                }
    ...
    public void setDefaultActivity(int i3) {
        ...
        synchronized (this.mInstanceLock) {
            try {
                ...
                if (activityResolveInfo2 != null) {
                    f4 = (activityResolveInfo2.weight - activityResolveInfo.weight) + 5.0f;
                } else {
                    f4 = 1.0f;
                }
                ActivityInfo activityInfo = activityResolveInfo.resolveInfo.activityInfo;
