...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    */
    ...
    public void onMeasure(int i3, int i5) {
        ...
        int measuredHeight;
        pullChildren();
        measureChildWithMargins(this.mActionBarTop, i3, 0, i5, 0);
        ...
        measureChildWithMargins(this.mContent, i3, 0, i5, 0);
    ...
    public void onNestedScroll(View view, int i3, int i5, int i6, int i7, int i8, int[] iArr) {
        onNestedScroll(view, i3, i5, i6, i7, i8);
    }
    ...
    public void onWindowSystemUiVisibilityChanged(int i3) {
        ...
        pullChildren();
        int i5 = this.mLastSystemUiVisibility ^ i3;
