...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public static class DropDownAdapter implements ListAdapter, SpinnerAdapter {
        ...
        public DropDownAdapter(@Nullable SpinnerAdapter spinnerAdapter, @Nullable Resources.Theme theme) {
            ...
            if (theme != null) {
                if (Build.VERSION.SDK_INT >= 23 && android.support.v4.media.a.A(spinnerAdapter)) {
                    android.widget.ThemedSpinnerAdapter n5 = android.support.v4.media.a.n(spinnerAdapter);
                    dropDownViewTheme = n5.getDropDownViewTheme();
                    if (dropDownViewTheme != theme) {
                        n5.setDropDownViewTheme(theme);
                    }
    ...
    public class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        public void computeContentWidth() {
            ...
            if (ViewUtils.isLayoutRtl(AppCompatSpinner.this)) {
                horizontalOriginalOffset = (((width - paddingRight) - getWidth()) - getHorizontalOriginalOffset()) + i3;
            } else {
                horizontalOriginalOffset = paddingLeft + getHorizontalOriginalOffset() + i3;
            }
    ...
    public AppCompatSpinner(@NonNull Context context, int i3) {
        this(context, null, R.attr.spinnerStyle, i3);
    }
    ...
    public AppCompatSpinner(@NonNull Context context, @Nullable AttributeSet attributeSet, int i3, int i5) {
