...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public void setNavigationMode(int i3) {
        ...
        if (i3 != i5) {
            if (i5 != 1) {
                if (i5 == 2 && (view = this.mTabView) != null) {
                    ViewParent parent = view.getParent();
                    Toolbar toolbar = this.mToolbar;
                    if (parent == toolbar) {
                        toolbar.removeView(this.mTabView);
            ...
            if (i3 != 0) {
                if (i3 != 1) {
                    ...
                    throw new IllegalArgumentException(i.e(i3, "Invalid navigation mode "));
                }
                ensureSpinner();
    ...
    @Override // androidx.appcompat.widget.DecorToolbar
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int i3, long j2) {
        float f4;
        ...
        return animate.alpha(f4).setDuration(j2).setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: androidx.appcompat.widget.ToolbarWidgetWrapper.2
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean z3, int i3, int i5) {
        Drawable drawable;
