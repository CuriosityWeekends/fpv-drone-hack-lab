...
public class AppCompatCheckBox extends CheckBox implements TintableCompoundButton, TintableBackgroundView {
    ...
    public AppCompatCheckBox(@NonNull Context context, @Nullable AttributeSet attributeSet, int i3) {
        ...
        appCompatCompoundButtonHelper.loadFromAttributes(attributeSet, i3);
