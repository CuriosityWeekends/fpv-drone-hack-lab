...
public class TintTypedArray {
    ...
    public int getColor(int i3, int i5) {
        return this.mWrapped.getColor(i3, i5);
    }
    ...
    public float getDimension(int i3, float f4) {
        return this.mWrapped.getDimension(i3, f4);
    }

    public int getDimensionPixelOffset(int i3, int i5) {
        return this.mWrapped.getDimensionPixelOffset(i3, i5);
    }

    public int getDimensionPixelSize(int i3, int i5) {
        return this.mWrapped.getDimensionPixelSize(i3, i5);
    }
    ...
    public float getFloat(int i3, float f4) {
        return this.mWrapped.getFloat(i3, f4);
    }

    @Nullable
    public Typeface getFont(@StyleableRes int i3, int i5, @Nullable ResourcesCompat.FontCallback fontCallback) {
    ...
    public float getFraction(int i3, int i5, int i6, float f4) {
        return this.mWrapped.getFraction(i3, i5, i6, f4);
    }
    ...
    public int getInt(int i3, int i5) {
        return this.mWrapped.getInt(i3, i5);
    }

    public int getInteger(int i3, int i5) {
        return this.mWrapped.getInteger(i3, i5);
    }
    ...
    public int getResourceId(int i3, int i5) {
        return this.mWrapped.getResourceId(i3, i5);
    }
    ...
    public static TintTypedArray obtainStyledAttributes(Context context, AttributeSet attributeSet, int[] iArr, int i3, int i5) {
        return new TintTypedArray(context, context.obtainStyledAttributes(attributeSet, iArr, i3, i5));
    }

    public int getLayoutDimension(int i3, int i5) {
        return this.mWrapped.getLayoutDimension(i3, i5);
    }
