...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    @Nullable
    public static AnimatedVectorDrawableCompat create(@NonNull Context context, @DrawableRes int i3) {
        int next;
        if (Build.VERSION.SDK_INT >= 24) {
            AnimatedVectorDrawableCompat animatedVectorDrawableCompat = new AnimatedVectorDrawableCompat(context);
            Drawable drawable = ResourcesCompat.getDrawable(context.getResources(), i3, context.getTheme());
    ...
    private void setupColorAnimator(Animator animator) {
        ...
        if ((animator instanceof AnimatorSet) && (childAnimations = ((AnimatorSet) animator).getChildAnimations()) != null) {
            for (int i3 = 0; i3 < childAnimations.size(); i3++) {
                setupColorAnimator(childAnimations.get(i3));
            }
        }
    ...
    public boolean onLevelChange(int i3) {
        ...
        return this.mAnimatedVectorState.mVectorDrawable.setLevel(i3);
    }
    ...
    public void setAlpha(int i3) {
        ...
        if (drawable != null) {
            ...
            this.mAnimatedVectorState.mVectorDrawable.setAlpha(i3);
        }
    }
    ...
    public void setTint(int i3) {
        ...
        if (drawable != null) {
            ...
            this.mAnimatedVectorState.mVectorDrawable.setTint(i3);
        }
    }
    ...
    public boolean setVisible(boolean z3, boolean z5) {
        ...
        this.mAnimatedVectorState.mVectorDrawable.setVisible(z3, z5);
