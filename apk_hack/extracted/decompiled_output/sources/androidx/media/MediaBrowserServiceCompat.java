...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public class ConnectionRecord implements IBinder.DeathRecipient {
        ...
        public ConnectionRecord(String str, int i3, int i5, Bundle bundle, ServiceCallbacks serviceCallbacks) {
            this.pkg = str;
            this.pid = i3;
            this.uid = i5;
            this.browserInfo = new MediaSessionManager.RemoteUserInfo(str, i3, i5);
    ...
    public class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl, MediaBrowserServiceCompatApi21.ServiceCompatProxy {
        ...
        public MediaBrowserServiceCompatApi21.BrowserRoot onGetRoot(String str, int i3, Bundle bundle) {
            Bundle bundle2;
            IBinder asBinder;
            ...
            mediaBrowserServiceCompat.mCurConnection = new ConnectionRecord(str, -1, i3, bundle, null);
        ...
        public void notifyChildrenChangedForCompat(final MediaSessionManager.RemoteUserInfo remoteUserInfo, final String str, final Bundle bundle) {
            MediaBrowserServiceCompat.this.mHandler.post(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi21.4
                @Override // java.lang.Runnable
                public void run() {
                    for (int i3 = 0; i3 < MediaBrowserServiceCompat.this.mConnections.size(); i3++) {
                        ConnectionRecord valueAt = MediaBrowserServiceCompat.this.mConnections.valueAt(i3);
    ...
    public class ServiceBinderImpl {
        ...
        public void connect(final String str, final int i3, final int i5, final Bundle bundle, final ServiceCallbacks serviceCallbacks) {
            if (MediaBrowserServiceCompat.this.isValidPackage(str, i5)) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.1
                    ...
                    public void run() {
                        ...
                        ConnectionRecord connectionRecord = new ConnectionRecord(str, i3, i5, bundle, serviceCallbacks);
                        MediaBrowserServiceCompat mediaBrowserServiceCompat = MediaBrowserServiceCompat.this;
        ...
        public void registerCallbacks(final ServiceCallbacks serviceCallbacks, final String str, final int i3, final int i5, final Bundle bundle) {
    ...
    public static class ServiceCallbacksCompat implements ServiceCallbacks {
        ...
        private void sendRequest(int i3, Bundle bundle) {
    ...
    public boolean isValidPackage(String str, int i3) {
        if (str == null) {
            return false;
        }
    ...
    public void performLoadItem(String str, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        ...
        throw new IllegalStateException(i.w("onLoadItem must call detach() or sendResult() before returning for id=", str));
    }
    ...
    public void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        ...
        throw new IllegalStateException(i.w("onSearch must call detach() or sendResult() before returning for query=", str));
    }
