...
public class ImageFilterView extends AppCompatImageView {
    ...
    public static class ImageMatrix {
        ...
        private void warmth(float f4) {
            ...
            if (f7 > 66.0f) {
                double d = f7 - 60.0f;
                f5 = ((float) Math.pow(d, -0.13320475816726685d)) * 329.69873f;
        ...
        public void updateMatrix(ImageView imageView) {
            ...
            if (f4 != 1.0f) {
                saturation(f4);
                this.mColorMatrix.set(this.f122m);
                z3 = true;
            } else {
                z3 = false;
            }
            ...
            if (f6 != 1.0f) {
                warmth(f6);
                this.mTmpColorMatrix.set(this.f122m);
                this.mColorMatrix.postConcat(this.mTmpColorMatrix);
                z3 = true;
            }
