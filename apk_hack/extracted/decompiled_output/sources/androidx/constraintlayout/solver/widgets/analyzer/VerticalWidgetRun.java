                ...
                if (i6 == 3 && constraintWidget3.horizontalRun.dimension.resolved) {
                    ...
                    if (dimensionRatioSide != -1) {
                        if (dimensionRatioSide != 0) {
                            ...
                            i3 = (int) ((this.widget.getDimensionRatio() * constraintWidget.horizontalRun.dimension.value) + 0.5f);
                        }
        ...
        if (dependencyNode.readyToSolve) {
            ...
            if (dependencyNode2.readyToSolve) {
                ...
                if (this.dimension.resolved && this.start.targets.size() > 0 && this.end.targets.size() > 0) {
                    ...
                    this.start.resolve((int) ((((i13 - i12) - this.dimension.value) * verticalBiasPercent) + i12 + 0.5f));
