...
public class ConstraintLayout extends ViewGroup {
    ...
    public class Measurer implements BasicMeasure.Measurer {
        ...
        public void captureLayoutInfos(int i3, int i5, int i6, int i7, int i8, int i9) {
            this.paddingTop = i6;
            this.paddingBottom = i7;
            this.paddingWidth = i8;
            this.paddingHeight = i9;
            this.layoutWidthSpec = i3;
        ...
        /* JADX WARN: Removed duplicated region for block: B:104:0x0171 A[ADDED_TO_REGION] */
        ...
        /* JADX WARN: Removed duplicated region for block: B:144:0x0208 A[ADDED_TO_REGION] */
    ...
    private final ConstraintWidget getTargetWidget(int i3) {
        if (i3 == 0) {
    ...
    private void init(AttributeSet attributeSet, int i3, int i5) {
        this.mLayoutWidget.setCompanionWidget(this);
        this.mLayoutWidget.setMeasurer(this.mMeasurer);
        this.mChildrenByIds.put(getId(), this);
        this.mConstraintSet = null;
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, R.styleable.ConstraintLayout_Layout, i3, i5);
    ...
    public void applyConstraintsFromLayoutParams(boolean z3, View view, ConstraintWidget constraintWidget, LayoutParams layoutParams, SparseArray<ConstraintWidget> sparseArray) {
        ...
        if (z3 && ((i3 = layoutParams.editorAbsoluteX) != -1 || layoutParams.editorAbsoluteY != -1)) {
            constraintWidget.setOrigin(i3, layoutParams.editorAbsoluteY);
        }
    ...
    public void onMeasure(int i3, int i5) {
        ...
        resolveMeasuredDimension(i3, i5, this.mLayoutWidget.getWidth(), this.mLayoutWidget.getHeight(), this.mLayoutWidget.isWidthMeasuredTooSmall(), this.mLayoutWidget.isHeightMeasuredTooSmall());
    }
    ...
    public void resolveMeasuredDimension(int i3, int i5, int i6, int i7, boolean z3, boolean z5) {
        Measurer measurer = this.mMeasurer;
        int i8 = measurer.paddingHeight;
        int resolveSizeAndState = View.resolveSizeAndState(i6 + measurer.paddingWidth, i3, 0);
    ...
    public void resolveSystem(ConstraintWidgetContainer constraintWidgetContainer, int i3, int i5, int i6) {
        int i7;
        ...
        constraintWidgetContainer.measure(i3, mode, i9, mode2, i10, this.mLastMeasureWidth, this.mLastMeasureHeight, i7, max);
    }
    ...
    public void setSelfDimensionBehaviour(ConstraintWidgetContainer constraintWidgetContainer, int i3, int i5, int i6, int i7) {
    ...
    @TargetApi(21)
    public ConstraintLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i3, int i5) {
                            ...
                            case 44:
                                ...
                                if (string != null) {
                                    ...
                                    if (indexOf2 >= 0 && indexOf2 < length - 1) {
                                        String substring2 = this.dimensionRatio.substring(i3, indexOf2);
                                        ...
                                        String substring4 = this.dimensionRatio.substring(i3);
