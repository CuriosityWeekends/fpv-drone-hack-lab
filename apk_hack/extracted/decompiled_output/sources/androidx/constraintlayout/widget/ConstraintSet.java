...
public class ConstraintSet {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static int lookupID(TypedArray typedArray, int i3, int i5) {
    ...
    private static String[] splitString(String str) {
        ...
        for (int i5 = 0; i5 < charArray.length; i5++) {
            char c = charArray[i5];
            if (c == ',' && !z3) {
                arrayList.add(new String(charArray, i3, i5 - i3));
                i3 = i5 + 1;
            } else if (c == '\"') {
                z3 = !z3;
            }
    ...
    public void addToHorizontalChain(int i3, int i5, int i6) {
        int i7;
        int i8;
        if (i5 == 0) {
            i7 = 1;
        ...
        connect(i3, 1, i5, i7, 0);
        if (i6 == 0) {
            i8 = 2;
        } else {
            i8 = 1;
        }
        connect(i3, 2, i6, i8, 0);
        if (i5 != 0) {
            connect(i5, 2, i3, 1, 0);
        }
        if (i6 != 0) {
    ...
    public void addToHorizontalChainRTL(int i3, int i5, int i6) {
        int i7;
        int i8;
        if (i5 == 0) {
            i7 = 6;
        ...
        connect(i3, 6, i5, i7, 0);
        if (i6 == 0) {
            i8 = 7;
        } else {
            i8 = 6;
        }
        connect(i3, 7, i6, i8, 0);
        if (i5 != 0) {
            connect(i5, 7, i3, 6, 0);
        }
        if (i6 != 0) {
    ...
    public void addToVerticalChain(int i3, int i5, int i6) {
        int i7;
        int i8;
        if (i5 == 0) {
            i7 = 3;
        ...
        connect(i3, 3, i5, i7, 0);
        if (i6 == 0) {
            i8 = 4;
        } else {
            i8 = 3;
        }
        connect(i3, 4, i6, i8, 0);
        if (i5 != 0) {
            connect(i5, 4, i3, 3, 0);
        }
        if (i6 != 0) {
    ...
    public void center(int i3, int i5, int i6, int i7, int i8, int i9, int i10, float f4) {
        if (i7 >= 0) {
            if (i10 >= 0) {
                if (f4 > 0.0f && f4 <= 1.0f) {
                    if (i6 != 1 && i6 != 2) {
                        if (i6 != 6 && i6 != 7) {
                            connect(i3, 3, i5, i6, i7);
                            connect(i3, 4, i8, i9, i10);
                            this.mConstraints.get(Integer.valueOf(i3)).layout.verticalBias = f4;
                            return;
                        }
                        connect(i3, 6, i5, i6, i7);
                        connect(i3, 7, i8, i9, i10);
                        this.mConstraints.get(Integer.valueOf(i3)).layout.horizontalBias = f4;
                        return;
                    }
                    connect(i3, 1, i5, i6, i7);
                    connect(i3, 2, i8, i9, i10);
                    this.mConstraints.get(Integer.valueOf(i3)).layout.horizontalBias = f4;
                    return;
                }
    ...
    public void centerHorizontally(int i3, int i5, int i6, int i7, int i8, int i9, int i10, float f4) {
        connect(i3, 1, i5, i6, i7);
        connect(i3, 2, i8, i9, i10);
        this.mConstraints.get(Integer.valueOf(i3)).layout.horizontalBias = f4;
    }

    public void centerHorizontallyRtl(int i3, int i5, int i6, int i7, int i8, int i9, int i10, float f4) {
        connect(i3, 6, i5, i6, i7);
        connect(i3, 7, i8, i9, i10);
        this.mConstraints.get(Integer.valueOf(i3)).layout.horizontalBias = f4;
    }

    public void centerVertically(int i3, int i5, int i6, int i7, int i8, int i9, int i10, float f4) {
        connect(i3, 3, i5, i6, i7);
        connect(i3, 4, i8, i9, i10);
        this.mConstraints.get(Integer.valueOf(i3)).layout.verticalBias = f4;
    }
    ...
    public void connect(int i3, int i5, int i6, int i7, int i8) {
        if (!this.mConstraints.containsKey(Integer.valueOf(i3))) {
            this.mConstraints.put(Integer.valueOf(i3), new Constraint());
        }
        ...
        switch (i5) {
            case 1:
                if (i7 == 1) {
                    ...
                    throw new IllegalArgumentException(i.k(new StringBuilder("Left to "), sideToString(i7), " undefined"));
                }
            ...
            case 2:
                if (i7 == 1) {
                    ...
                    throw new IllegalArgumentException(i.k(new StringBuilder("right to "), sideToString(i7), " undefined"));
                }
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(i.k(sb, sideToString(i7), " unknown"));
        }
    }

    public void constrainCircle(int i3, int i5, int i6, float f4) {
    ...
    public void constrainDefaultHeight(int i3, int i5) {
        get(i3).layout.heightDefault = i5;
    }

    public void constrainDefaultWidth(int i3, int i5) {
        get(i3).layout.widthDefault = i5;
    }

    public void constrainHeight(int i3, int i5) {
        get(i3).layout.mHeight = i5;
    }

    public void constrainMaxHeight(int i3, int i5) {
        get(i3).layout.heightMax = i5;
    }

    public void constrainMaxWidth(int i3, int i5) {
        get(i3).layout.widthMax = i5;
    }

    public void constrainMinHeight(int i3, int i5) {
        get(i3).layout.heightMin = i5;
    }

    public void constrainMinWidth(int i3, int i5) {
        get(i3).layout.widthMin = i5;
    }

    public void constrainPercentHeight(int i3, float f4) {
        get(i3).layout.heightPercent = f4;
    }

    public void constrainPercentWidth(int i3, float f4) {
        get(i3).layout.widthPercent = f4;
    }

    public void constrainWidth(int i3, int i5) {
        get(i3).layout.mWidth = i5;
    }

    public void constrainedHeight(int i3, boolean z3) {
        get(i3).layout.constrainedHeight = z3;
    }

    public void constrainedWidth(int i3, boolean z3) {
        get(i3).layout.constrainedWidth = z3;
    }

    public void create(int i3, int i5) {
        Layout layout = get(i3).layout;
        layout.mIsGuideline = true;
        layout.orientation = i5;
    }

    public void createBarrier(int i3, int i5, int i6, int... iArr) {
        Layout layout = get(i3).layout;
        layout.mHelperType = 1;
    ...
    public void createHorizontalChain(int i3, int i5, int i6, int i7, int[] iArr, float[] fArr, int i8) {
        createHorizontalChain(i3, i5, i6, i7, iArr, fArr, i8, 1, 2);
    }

    public void createHorizontalChainRtl(int i3, int i5, int i6, int i7, int[] iArr, float[] fArr, int i8) {
        createHorizontalChain(i3, i5, i6, i7, iArr, fArr, i8, 6, 7);
    }

    public void createVerticalChain(int i3, int i5, int i6, int i7, int[] iArr, float[] fArr, int i8) {
        if (iArr.length >= 2) {
    ...
    public void setAlpha(int i3, float f4) {
        get(i3).propertySet.alpha = f4;
    }

    public void setApplyElevation(int i3, boolean z3) {
        get(i3).transform.applyElevation = z3;
    }

    public void setBarrierType(int i3, int i5) {
        get(i3).layout.mHelperType = i5;
    }

    public void setColorValue(int i3, String str, int i5) {
        get(i3).setColorValue(str, i5);
    }
    ...
    public void setEditorAbsoluteX(int i3, int i5) {
        get(i3).layout.editorAbsoluteX = i5;
    }

    public void setEditorAbsoluteY(int i3, int i5) {
        get(i3).layout.editorAbsoluteY = i5;
    }

    public void setElevation(int i3, float f4) {
        get(i3).transform.elevation = f4;
        get(i3).transform.applyElevation = true;
    }

    public void setFloatValue(int i3, String str, float f4) {
        get(i3).setFloatValue(str, f4);
    }
    ...
    public void setGoneMargin(int i3, int i5, int i6) {
    ...
    public void setGuidelineBegin(int i3, int i5) {
        get(i3).layout.guideBegin = i5;
        get(i3).layout.guideEnd = -1;
        get(i3).layout.guidePercent = -1.0f;
    }

    public void setGuidelineEnd(int i3, int i5) {
        get(i3).layout.guideEnd = i5;
        get(i3).layout.guideBegin = -1;
        get(i3).layout.guidePercent = -1.0f;
    }

    public void setGuidelinePercent(int i3, float f4) {
        get(i3).layout.guidePercent = f4;
        get(i3).layout.guideEnd = -1;
        get(i3).layout.guideBegin = -1;
    }

    public void setHorizontalBias(int i3, float f4) {
        get(i3).layout.horizontalBias = f4;
    }

    public void setHorizontalChainStyle(int i3, int i5) {
        get(i3).layout.horizontalChainStyle = i5;
    }

    public void setHorizontalWeight(int i3, float f4) {
        get(i3).layout.horizontalWeight = f4;
    }

    public void setIntValue(int i3, String str, int i5) {
        get(i3).setIntValue(str, i5);
    }

    public void setMargin(int i3, int i5, int i6) {
        Constraint constraint = get(i3);
        switch (i5) {
            case 1:
    ...
    public void setRotation(int i3, float f4) {
        get(i3).transform.rotation = f4;
    }

    public void setRotationX(int i3, float f4) {
        get(i3).transform.rotationX = f4;
    }

    public void setRotationY(int i3, float f4) {
        get(i3).transform.rotationY = f4;
    }

    public void setScaleX(int i3, float f4) {
        get(i3).transform.scaleX = f4;
    }

    public void setScaleY(int i3, float f4) {
        get(i3).transform.scaleY = f4;
    }
    ...
    public void setTransformPivot(int i3, float f4, float f5) {
        Transform transform = get(i3).transform;
        transform.transformPivotY = f5;
        transform.transformPivotX = f4;
    }

    public void setTransformPivotX(int i3, float f4) {
        get(i3).transform.transformPivotX = f4;
    }

    public void setTransformPivotY(int i3, float f4) {
        get(i3).transform.transformPivotY = f4;
    }

    public void setTranslation(int i3, float f4, float f5) {
        Transform transform = get(i3).transform;
        transform.translationX = f4;
        transform.translationY = f5;
    }

    public void setTranslationX(int i3, float f4) {
        get(i3).transform.translationX = f4;
    }

    public void setTranslationY(int i3, float f4) {
        get(i3).transform.translationY = f4;
    }

    public void setTranslationZ(int i3, float f4) {
        get(i3).transform.translationZ = f4;
    }
    ...
    public void setVerticalBias(int i3, float f4) {
        get(i3).layout.verticalBias = f4;
    }

    public void setVerticalChainStyle(int i3, int i5) {
        get(i3).layout.verticalChainStyle = i5;
    }

    public void setVerticalWeight(int i3, float f4) {
        get(i3).layout.verticalWeight = f4;
    }

    public void setVisibility(int i3, int i5) {
        get(i3).propertySet.visibility = i5;
    }

    public void setVisibilityMode(int i3, int i5) {
        get(i3).propertySet.mVisibilityMode = i5;
    }

    private void createHorizontalChain(int i3, int i5, int i6, int i7, int[] iArr, float[] fArr, int i8, int i9, int i10) {
        if (iArr.length >= 2) {
            if (fArr != null && fArr.length != iArr.length) {
                throw new IllegalArgumentException("must have 2 or more widgets in a chain");
            }
    ...
    public void clear(int i3, int i5) {
        if (this.mConstraints.containsKey(Integer.valueOf(i3))) {
            Constraint constraint = this.mConstraints.get(Integer.valueOf(i3));
            switch (i5) {
                case 1:
    ...
    public void centerHorizontally(int i3, int i5) {
        if (i5 == 0) {
            center(i3, 0, 1, 0, 0, 2, 0, 0.5f);
        } else {
            center(i3, i5, 2, 0, i5, 1, 0, 0.5f);
        }
    }

    public void centerHorizontallyRtl(int i3, int i5) {
        if (i5 == 0) {
            center(i3, 0, 6, 0, 0, 7, 0, 0.5f);
        } else {
            center(i3, i5, 7, 0, i5, 6, 0, 0.5f);
        }
    }

    public void centerVertically(int i3, int i5) {
        if (i5 == 0) {
            center(i3, 0, 3, 0, 0, 4, 0, 0.5f);
        } else {
            center(i3, i5, 4, 0, i5, 3, 0, 0.5f);
        }
    }
    ...
    */
    ...
    public void connect(int i3, int i5, int i6, int i7) {
        if (!this.mConstraints.containsKey(Integer.valueOf(i3))) {
            this.mConstraints.put(Integer.valueOf(i3), new Constraint());
        }
        Constraint constraint = this.mConstraints.get(Integer.valueOf(i3));
