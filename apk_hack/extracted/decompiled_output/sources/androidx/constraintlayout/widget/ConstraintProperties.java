...
public class ConstraintProperties {
    ...
    public ConstraintProperties addToHorizontalChain(int i3, int i5) {
        int i6;
        int i7;
        if (i3 == 0) {
            i6 = 1;
    ...
    public ConstraintProperties addToHorizontalChainRTL(int i3, int i5) {
        int i6;
        int i7;
        if (i3 == 0) {
            i6 = 6;
    ...
    public ConstraintProperties addToVerticalChain(int i3, int i5) {
        int i6;
        int i7;
        if (i3 == 0) {
            i6 = 3;
    ...
    public ConstraintProperties center(int i3, int i5, int i6, int i7, int i8, int i9, float f4) {
        if (i6 >= 0) {
            if (i9 >= 0) {
                if (f4 > 0.0f && f4 <= 1.0f) {
                    if (i5 != 1 && i5 != 2) {
    ...
    public ConstraintProperties centerHorizontally(int i3, int i5, int i6, int i7, int i8, int i9, float f4) {
        connect(1, i3, i5, i6);
        connect(2, i7, i8, i9);
        this.mParams.horizontalBias = f4;
        return this;
    ...
    public ConstraintProperties centerHorizontallyRtl(int i3, int i5, int i6, int i7, int i8, int i9, float f4) {
        connect(6, i3, i5, i6);
        connect(7, i7, i8, i9);
        this.mParams.horizontalBias = f4;
        return this;
    ...
    public ConstraintProperties centerVertically(int i3, int i5, int i6, int i7, int i8, int i9, float f4) {
        connect(3, i3, i5, i6);
        connect(4, i7, i8, i9);
        this.mParams.verticalBias = f4;
        return this;
    ...
    public ConstraintProperties connect(int i3, int i5, int i6, int i7) {
        switch (i3) {
            case 1:
                if (i6 == 1) {
                    ...
                    throw new IllegalArgumentException(i.k(new StringBuilder("Left to "), sideToString(i6), " undefined"));
                }
            ...
            case 2:
                if (i6 == 1) {
                    ...
                    throw new IllegalArgumentException(i.k(new StringBuilder("right to "), sideToString(i6), " undefined"));
                }
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(i.k(sb, sideToString(i6), " unknown"));
        }
        return this;
    }
    ...
    public ConstraintProperties goneMargin(int i3, int i5) {
        switch (i3) {
            case 1:
    ...
    public ConstraintProperties margin(int i3, int i5) {
        switch (i3) {
            case 1:
