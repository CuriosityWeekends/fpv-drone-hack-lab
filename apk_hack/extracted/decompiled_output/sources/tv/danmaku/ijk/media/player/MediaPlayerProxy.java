...
public class MediaPlayerProxy implements IMediaPlayer {
    ...
    public void setAudioStreamType(int i3) {
        this.mBackEndMediaPlayer.setAudioStreamType(i3);
    }
        ...
        if (onBufferingUpdateListener != null) {
            this.mBackEndMediaPlayer.setOnBufferingUpdateListener(new IMediaPlayer.OnBufferingUpdateListener() { // from class: tv.danmaku.ijk.media.player.MediaPlayerProxy.3
                ...
                public void onBufferingUpdate(IMediaPlayer iMediaPlayer, int i3) {
                    onBufferingUpdateListener.onBufferingUpdate(MediaPlayerProxy.this, i3);
                }
            });
        } else {
    ...
    public void setOnErrorListener(final IMediaPlayer.OnErrorListener onErrorListener) {
        if (onErrorListener != null) {
            this.mBackEndMediaPlayer.setOnErrorListener(new IMediaPlayer.OnErrorListener() { // from class: tv.danmaku.ijk.media.player.MediaPlayerProxy.6
                ...
                public boolean onError(IMediaPlayer iMediaPlayer, int i3, int i5) {
                    return onErrorListener.onError(MediaPlayerProxy.this, i3, i5);
                }
            });
        } else {
    ...
    public void setOnInfoListener(final IMediaPlayer.OnInfoListener onInfoListener) {
        if (onInfoListener != null) {
            this.mBackEndMediaPlayer.setOnInfoListener(new IMediaPlayer.OnInfoListener() { // from class: tv.danmaku.ijk.media.player.MediaPlayerProxy.7
                ...
                public boolean onInfo(IMediaPlayer iMediaPlayer, int i3, int i5) {
                    return onInfoListener.onInfo(MediaPlayerProxy.this, i3, i5);
                }
            });
        } else {
    ...
    public void setOnVideoSizeChangedListener(final IMediaPlayer.OnVideoSizeChangedListener onVideoSizeChangedListener) {
        if (onVideoSizeChangedListener != null) {
            this.mBackEndMediaPlayer.setOnVideoSizeChangedListener(new IMediaPlayer.OnVideoSizeChangedListener() { // from class: tv.danmaku.ijk.media.player.MediaPlayerProxy.5
                ...
                public void onVideoSizeChanged(IMediaPlayer iMediaPlayer, int i3, int i5, int i6, int i7) {
                    onVideoSizeChangedListener.onVideoSizeChanged(MediaPlayerProxy.this, i3, i5, i6, i7);
                }
            });
        } else {
    ...
    public void setWakeMode(Context context, int i3) {
        this.mBackEndMediaPlayer.setWakeMode(context, i3);
    }
