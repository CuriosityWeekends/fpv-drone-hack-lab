        ...
        private void buildRenderers() {
            ...
            for (int i3 = 0; i3 < period.adaptationSets.size(); i3++) {
                ...
                if (adaptationSet.type != -1) {
                    z5 |= adaptationSet.hasContentProtection();
                }
            }
            ...
            if (z5) {
                ...
                try {
                    ...
                    this.player.onRenderersError(e5);
                    return;
                }
            }
            z3 = false;
