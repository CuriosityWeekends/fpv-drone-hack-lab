...
public class SmartDivider extends RecyclerView.ItemDecoration {
    ...
    public SmartDivider(Context context, int i3) {
    ...
    private void drawHorizontal(Canvas canvas, RecyclerView recyclerView) {
        ...
        if (recyclerView.getClipToPadding()) {
            ...
            canvas.clipRect(recyclerView.getPaddingStart(), i3, recyclerView.getWidth() - recyclerView.getPaddingEnd(), height);
        } else {
            height = recyclerView.getHeight();
            i3 = 0;
        }
        int childCount = recyclerView.getChildCount();
        for (int i5 = 0; i5 < childCount && i5 != childCount - 1; i5++) {
