...
public class MaterialAttributes {
    ...
    public static boolean resolveBoolean(@NonNull Context context, @AttrRes int i3, boolean z3) {
    ...
    public static boolean resolveBooleanOrThrow(@NonNull Context context, @AttrRes int i3, @NonNull String str) {
        if (resolveOrThrow(context, i3, str) != 0) {
            return true;
        }
        return false;
    }
    ...
    @Px
    public static int resolveDimension(@NonNull Context context, @AttrRes int i3, @DimenRes int i5) {
        float dimension;
        TypedValue resolve = resolve(context, i3);
    ...
    public static int resolveInteger(@NonNull Context context, @AttrRes int i3, int i5) {
        TypedValue resolve = resolve(context, i3);
    ...
    public static int resolveOrThrow(@NonNull View view, @AttrRes int i3) {
        return resolveOrThrow(view.getContext(), i3, view.getClass().getCanonicalName());
    }
}
