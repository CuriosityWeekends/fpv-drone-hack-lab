...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    public class CheckedStateTracker implements MaterialButton.OnCheckedChangeListener {
        ...
        public void onCheckedChanged(@NonNull MaterialButton materialButton, boolean z3) {
            ...
            if (MaterialButtonToggleGroup.this.singleSelection) {
                ...
                if (z3) {
                    i3 = materialButton.getId();
                } else {
                    i3 = -1;
                }
                materialButtonToggleGroup.checkedId = i3;
            }
    ...
    private void checkForced(int i3, boolean z3) {
    ...
    public void dispatchOnButtonChecked(@IdRes int i3, boolean z3) {
    ...
    @Nullable
    private CornerData getNewCornerData(int i3, int i5, int i6) {
        boolean z3;
    ...
    private void setCheckedId(int i3) {
        this.checkedId = i3;
        dispatchOnButtonChecked(i3, true);
    }

    private void setCheckedStateForView(@IdRes int i3, boolean z3) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean updateCheckedStates(int i3, boolean z3) {
    ...
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        wrap.setCollectionInfo(AccessibilityNodeInfoCompat.CollectionInfoCompat.obtain(1, visibleButtonCount, false, i3));
    }
