...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private float calculateValueOfAnimationAtEndOfExpansion(@NonNull FabTransformationSpec fabTransformationSpec, @NonNull MotionTiming motionTiming, float f4, float f5) {
        ...
        return AnimationUtils.lerp(f4, f5, motionTiming.getInterpolator().getInterpolation(((float) (((timing.getDuration() + delay2) + 17) - delay)) / ((float) duration)));
    }
    ...
    private void createChildrenFadeAnimation(View view, View view2, boolean z3, boolean z5, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
    ...
    private void createColorAnimation(@NonNull View view, View view2, boolean z3, boolean z5, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (z3) {
            ...
            ofInt = ObjectAnimator.ofInt(circularRevealWidget, CircularRevealWidget.CircularRevealScrimColorProperty.CIRCULAR_REVEAL_SCRIM_COLOR, i3);
        } else {
    ...
    @TargetApi(21)
    private void createElevationAnimation(View view, @NonNull View view2, boolean z3, boolean z5, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
        ObjectAnimator ofFloat;
    ...
    private void createExpansionAnimation(@NonNull View view, View view2, boolean z3, boolean z5, @NonNull FabTransformationSpec fabTransformationSpec, float f4, float f5, @NonNull List<Animator> list, @NonNull List<Animator.AnimatorListener> list2) {
        Animator animator;
        if (!(view2 instanceof CircularRevealWidget)) {
            return;
        }
        ...
        if (z3) {
            ...
            createPreFillRadialExpansion(view2, timing.getDelay(), i3, i5, f6, list);
            createPostFillRadialExpansion(view2, timing.getDelay(), timing.getDuration(), fabTransformationSpec.timings.getTotalDuration(), i3, i5, width, list);
    ...
    private void createIconFadeAnimation(View view, final View view2, boolean z3, boolean z5, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, @NonNull List<Animator.AnimatorListener> list2) {
        ObjectAnimator ofInt;
    ...
    private void createPostFillRadialExpansion(View view, long j2, long j5, long j6, int i3, int i5, float f4, @NonNull List<Animator> list) {
        long j7 = j2 + j5;
        if (j7 < j6) {
            Animator createCircularReveal = ViewAnimationUtils.createCircularReveal(view, i3, i5, f4, f4);
    ...
    private void createPreFillRadialExpansion(View view, long j2, int i3, int i5, float f4, @NonNull List<Animator> list) {
        if (j2 > 0) {
            Animator createCircularReveal = ViewAnimationUtils.createCircularReveal(view, i3, i5, f4, f4);
    ...
    private void createTranslationAnimation(@NonNull View view, @NonNull View view2, boolean z3, boolean z5, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2, @NonNull RectF rectF) {
        ObjectAnimator ofFloat;
    ...
    @NonNull
    public AnimatorSet onCreateExpandedStateChangeAnimation(@NonNull final View view, @NonNull final View view2, final boolean z3, boolean z5) {
        ...
        createElevationAnimation(view, view2, z3, z5, onCreateMotionSpec, arrayList, arrayList2);
        RectF rectF = this.tmpRectF1;
        createTranslationAnimation(view, view2, z3, z5, onCreateMotionSpec, arrayList, arrayList2, rectF);
        float width = rectF.width();
        float height = rectF.height();
        createDependencyTranslationAnimation(view, view2, z3, onCreateMotionSpec, arrayList);
        createIconFadeAnimation(view, view2, z3, z5, onCreateMotionSpec, arrayList, arrayList2);
        createExpansionAnimation(view, view2, z3, z5, onCreateMotionSpec, width, height, arrayList, arrayList2);
        createColorAnimation(view, view2, z3, z5, onCreateMotionSpec, arrayList, arrayList2);
        createChildrenFadeAnimation(view, view2, z3, z5, onCreateMotionSpec, arrayList, arrayList2);
