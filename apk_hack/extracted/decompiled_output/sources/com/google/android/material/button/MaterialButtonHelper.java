...
public class MaterialButtonHelper {
    ...
    private Drawable createBackground() {
        ...
        if (this.shouldDrawSurfaceColorStroke) {
            i3 = MaterialColors.getColor(this.materialButton, R.attr.colorSurface);
        } else {
            i3 = 0;
        }
        materialShapeDrawable2.setStroke(f4, i3);
        if (IS_LOLLIPOP) {
    ...
    private void setVerticalInsets(@Dimension int i3, @Dimension int i5) {
        ...
        ViewCompat.setPaddingRelative(this.materialButton, paddingStart, (paddingTop + i3) - i6, paddingEnd, (paddingBottom + i5) - i7);
    }
    ...
    private void updateStroke() {
        ...
        if (materialShapeDrawable != null) {
            ...
            if (surfaceColorStrokeDrawable != null) {
                ...
                surfaceColorStrokeDrawable.setStroke(f4, i3);
            }
        }
    }
    ...
    public void updateMaskBounds(int i3, int i5) {
        Drawable drawable = this.maskDrawable;
        if (drawable != null) {
            drawable.setBounds(this.insetLeft, this.insetTop, i5 - this.insetRight, i3 - this.insetBottom);
        }
    }
