...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    public void setAncestorContentPadding(int i3, int i5, int i6, int i7) {
    ...
    public void setContentPadding(int i3, int i5, int i6, int i7) {
        this.cardViewHelper.setUserContentPadding(i3, i5, i6, i7);
    }
    ...
    public void setStrokeColor(@ColorInt int i3) {
        this.cardViewHelper.setStrokeColor(ColorStateList.valueOf(i3));
    }
