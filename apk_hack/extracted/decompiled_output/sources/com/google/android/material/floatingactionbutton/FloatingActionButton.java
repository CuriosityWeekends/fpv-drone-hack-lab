...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    public class ShadowDelegateImpl implements ShadowViewDelegate {
        ...
        @Override // com.google.android.material.shadow.ShadowViewDelegate
        public void setShadowPadding(int i3, int i5, int i6, int i7) {
            FloatingActionButton.this.shadowPadding.set(i3, i5, i6, i7);
            FloatingActionButton floatingActionButton = FloatingActionButton.this;
            floatingActionButton.setPadding(floatingActionButton.imagePadding + i3, FloatingActionButton.this.imagePadding + i5, FloatingActionButton.this.imagePadding + i6, FloatingActionButton.this.imagePadding + i7);
        }
    }
    ...
    private static int resolveAdjustedSize(int i3, int i5) {
    ...
    public void onMeasure(int i3, int i5) {
        ...
        int min = Math.min(resolveAdjustedSize(sizeDimension, i3), resolveAdjustedSize(sizeDimension, i5));
