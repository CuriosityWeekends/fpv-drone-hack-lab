...
public class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    private void addRippleEffectOnFilledLayout(@NonNull AutoCompleteTextView autoCompleteTextView, int i3, int[][] iArr, @NonNull MaterialShapeDrawable materialShapeDrawable) {
        int boxBackgroundColor = this.textInputLayout.getBoxBackgroundColor();
        int[] iArr2 = {MaterialColors.layer(i3, boxBackgroundColor, 0.1f), boxBackgroundColor};
        if (IS_LOLLIPOP) {
    ...
    private void addRippleEffectOnOutlinedLayout(@NonNull AutoCompleteTextView autoCompleteTextView, int i3, int[][] iArr, @NonNull MaterialShapeDrawable materialShapeDrawable) {
    ...
    private MaterialShapeDrawable getPopUpMaterialShapeDrawable(float f4, float f5, float f6, int i3) {
    ...
    public void initialize() {
        ...
        if (IS_LOLLIPOP) {
            ...
            i3 = R.drawable.mtrl_ic_arrow_drop_down;
        }
        this.textInputLayout.setEndIconDrawable(AppCompatResources.getDrawable(this.context, i3));
