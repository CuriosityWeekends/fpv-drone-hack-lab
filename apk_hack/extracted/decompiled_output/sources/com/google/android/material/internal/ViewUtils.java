...
public class ViewUtils {
    ...
    public static void doOnApplyWindowInsets(@NonNull View view, @Nullable AttributeSet attributeSet, int i3, int i5) {
        doOnApplyWindowInsets(view, attributeSet, i3, i5, null);
    }
    ...
    public static void doOnApplyWindowInsets(@NonNull View view, @Nullable AttributeSet attributeSet, int i3, int i5, @Nullable final OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
    ...
    public static class RelativePadding {
        ...
        public RelativePadding(int i3, int i5, int i6, int i7) {
            this.start = i3;
            this.top = i5;
            this.end = i6;
            this.bottom = i7;
