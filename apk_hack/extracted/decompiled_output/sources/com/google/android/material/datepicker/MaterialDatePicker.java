...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private static int getDialogPickerHeight(@NonNull Context context) {
        ...
        return i5 + (resources.getDimensionPixelOffset(R.dimen.mtrl_calendar_month_vertical_padding) * (i3 - 1)) + (resources.getDimensionPixelSize(R.dimen.mtrl_calendar_day_height) * i3) + resources.getDimensionPixelOffset(R.dimen.mtrl_calendar_bottom_padding);
    }
    ...
    private static int getPaddedPickerWidth(@NonNull Context context) {
        ...
        return i.v(i3, 1, resources.getDimensionPixelOffset(R.dimen.mtrl_calendar_month_horizontal_padding), (resources.getDimensionPixelSize(R.dimen.mtrl_calendar_day_width) * i3) + (dimensionPixelOffset * 2));
    }
    ...
    public static final class Builder<S> {
        ...
        private Month createDefaultOpenAt() {
            ...
            if (!this.dateSelector.getSelectedDays().isEmpty()) {
                ...
                if (longValue >= j2 && longValue <= j5) {
                    return Month.create(longValue);
                }
            }
            long thisMonthInUtcMilliseconds = MaterialDatePicker.thisMonthInUtcMilliseconds();
            if (j2 <= thisMonthInUtcMilliseconds && thisMonthInUtcMilliseconds <= j5) {
