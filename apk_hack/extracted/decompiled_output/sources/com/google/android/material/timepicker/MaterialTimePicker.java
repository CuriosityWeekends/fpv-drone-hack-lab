...
public final class MaterialTimePicker extends DialogFragment {
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setMinute(@IntRange(from = 0, to = 60) int i3) {
    ...
    private Pair<Integer, Integer> dataForMode(int i3) {
        if (i3 != 0) {
            ...
            throw new IllegalArgumentException(i.e(i3, "no icon for mode: "));
        }
    ...
    private TimePickerPresenter initializeOrRetrieveActivePresenterForMode(int i3) {
        if (i3 == 0) {
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, i3, i5);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, R.styleable.MaterialTimePicker, i3, i5);
    ...
    public final View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        this.modeButton.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.timepicker.MaterialTimePicker.4
            ...
            public void onClick(View view) {
                ...
                materialTimePicker.inputMode = i5;
