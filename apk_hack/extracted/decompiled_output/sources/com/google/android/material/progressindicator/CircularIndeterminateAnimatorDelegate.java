...
public final class CircularIndeterminateAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private void maybeUpdateSegmentColors(int i3) {
        for (int i5 = 0; i5 < 4; i5++) {
            float fractionInRange = getFractionInRange(i3, DELAY_TO_FADE_IN_MS[i5], 333);
    ...
    private void updateSegmentPositions(int i3) {
        ...
        fArr[1] = f4 * 1520.0f;
        for (int i5 = 0; i5 < 4; i5++) {
            float fractionInRange = getFractionInRange(i3, DELAY_TO_EXPAND_IN_MS[i5], 667);
            float[] fArr2 = this.segmentPositions;
            fArr2[1] = (this.interpolator.getInterpolation(fractionInRange) * 250.0f) + fArr2[1];
            float fractionInRange2 = getFractionInRange(i3, DELAY_TO_COLLAPSE_IN_MS[i5], 667);
        ...
        float f5 = fArr4[0];
        float f6 = fArr4[1];
        float f7 = ((f6 - f5) * this.completeEndFraction) + f5;
        fArr4[0] = f7;
        fArr4[0] = f7 / 360.0f;
        fArr4[1] = f6 / 360.0f;
    }
